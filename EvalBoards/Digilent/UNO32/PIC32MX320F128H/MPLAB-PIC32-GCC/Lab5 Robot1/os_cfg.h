...
#define OS_CFG_OBJ_TYPE_CHK_EN          1u // mjb 0u   /* Enable (1) or Disable (0) object type checking                        */
...
#define OS_CFG_PRIO_MAX                 16u // mjb 8u   /* Defines the maximum number of task priorities (see OS_PRIO data type) */
...
#define OS_CFG_STK_SIZE_MIN            64u   /* Minimum allowable task stack size                                     */
                                             ...
                                             /* ----------------------------- EVENT FLAGS --------------------------- */
#define OS_CFG_FLAG_EN                 0u // mjb 1u   /* Enable (1) or Disable (0) code generation for EVENT FLAGS             */
...
#define OS_CFG_FLAG_PEND_ABORT_EN       1u   /*     Include code for OSFlagPendAbort()                                */
                                             ...
                                             /* -------------------------- MEMORY MANAGEMENT ------------------------ */
#define OS_CFG_MEM_EN                  0u //mjb  1u   /* Enable (1) or Disable (0) code generation for MEMORY MANAGER          */


                                             /* --------------------- MUTUAL EXCLUSION SEMAPHORES ------------------- */
#define OS_CFG_MUTEX_EN                 0u // mjb 1u   /* Enable (1) or Disable (0) code generation for MUTEX                   */
...
#define OS_CFG_MUTEX_PEND_ABORT_EN      1u   /*     Include code for OSMutexPendAbort()                               */
                                             ...
                                             /* --------------------------- MESSAGE QUEUES -------------------------- */
#define OS_CFG_Q_EN                     0u // mjb 1u   /* Enable (1) or Disable (0) code generation for QUEUES                  */
...
#define OS_CFG_SEM_SET_EN               1u   /*    Include code for OSSemSet()                                        */
                                             ...
                                             /* -------------------------- TASK MANAGEMENT -------------------------- */
#define OS_CFG_STAT_TASK_EN             0u // mjb 1u   /* Enable (1) or Disable(0) the statistics task                          */
